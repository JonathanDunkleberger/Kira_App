  ...
  return (
    <main className="min-h-screen bg-[#0b0b12] text-white p-4 md:p-8">
      <div className="w-full max-w-2xl mx-auto prose prose-invert">
        ...
        <p>
          By accessing or using Kira AI ("Service"), you agree to be bound by these Terms. If you
        ...
        <p>
          ...
          advance on a recurring and periodic basis ("Billing Cycle"). Billing cycles are set on a
          monthly basis.
        </p>
        <p>
          Your Subscription will automatically renew under the exact same conditions unless you
          cancel it or we cancel it. You may cancel your Subscription renewal through your online
          account management page provided by our third-party payment processor, Stripe.
        </p>
